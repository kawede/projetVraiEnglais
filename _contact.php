            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"style="font-family: tahoma;"><a href="#"><i class="fa fa-home" aria-hidden="true" style="color:blue;"></i> Contact</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-7 col-lg-8">
                    ...
                    <p>Presentation d'avant contact.</p>
                    ...
                    <div class="contact-form-area mt-50">
                        <form action="#" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" class="form-control" id="message" cols="30" rows="10" style="color:white; font-family:tahoma;"></textarea>
                            </div>
